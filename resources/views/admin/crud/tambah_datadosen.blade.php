...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
  ...
  <div class="bg-white shadow-lg rounded-xl p-8 w-full max-w-4xl">
    <h1 class="text-2xl font-bold mb-6 text-center text-blue-600">Tambah Dosen</h1>

  <form action="{{ route('dosen.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
@csrf
